...
* `Lecture Slides <_static/resources/ysc3248-week-13-paxos.pdf>`_
* `Paxos Made Simple
...
* `Code with examples
  <https://github.com/ysc3248/lectures-2020/tree/13-paxos>`_, package ``paxos``
...
* `Lecture Slides <_static/resources/ysc3248-week-13-byzantine.pdf>`_
